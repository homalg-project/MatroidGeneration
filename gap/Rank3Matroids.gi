    ...
    r := rec(
             ...
             NextIterator := function(it)
               ...
               while (Length(stack) > 0) do
                   ...
                   # Here we make sure that the atoms are weakly balanced with respect to the flats of size at least 3.
                   # This is no restrictions since all matroids have this property.
